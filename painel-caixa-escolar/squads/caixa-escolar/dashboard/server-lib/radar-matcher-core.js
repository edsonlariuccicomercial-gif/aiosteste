...
export const MATCH_LAYER = { N1: 'N1', N2: 'N2', N3: 'N3', N4: 'N4' };

// Thresholds (Story 13.5: token similarity elevado para 0.7)
export const TOKEN_THRESHOLD = 0.7;
...
export const MIN_REF_TOKENS = 2;

// Palavras-ruído removidas antes de comparar (não distinguem produtos)
export const NOISE = ['tipo', 'pct', 'c/', 'un', 'marca', 'de', 'do', 'da', 'com', 'para', 'em',
...
export const BRAND_BLACKLIST = ['yoki', 'camil', 'kicaldo', 'urbano', 'tio joao', 'dona benta',
 ...
 */
export function tokenCoverage(ref, full) {
 ...
 */
export function extractReferencePrice(texto) {
 ...
 */
export function extractReferenceBrands(texto) {
  const s = String(texto || '');
 ...
 */
export function isBrandCompliant(marcaCotada, marcasExigidas) {
 ...
 */
export function matchRegexRules(itemName, produtos = []) {
 ...
 */
export function matchProduct(itemName, ctx = {}) {
