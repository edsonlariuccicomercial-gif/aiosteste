/* AUTO-GERADO de product-store-core.js — NÃO editar à mão.
...
const MERGE_ORDER = [SOURCE.SSOT, SOURCE.BANCO, SOURCE.INTEL, SOURCE.ESTOQUE];
 ...
 */
function toCanonical(raw, source, opts = {}) {
 ...
 */
function mergeIntoSSoT(bases = {}, opts = {}) {
  const now = opts.now || null;
 ...
 */
function validateSSoT(itens, opts = {}) {
  ...
  root.ProductStoreCore = { SOURCE, MERGE_ORDER, emptyProduct, generateId, toCanonical, dedupeKey, enrich, mergeIntoSSoT, validateSSoT };
