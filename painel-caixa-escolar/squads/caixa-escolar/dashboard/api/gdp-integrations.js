...
export default async function handler(req, res) {
  ...
  try {
    ...
    if (req.method === "GET") {
      ...
      // DANFE única (2026-07-02, T3): devolve o emitente REAL (fonte canonica = env vars) para o
      // front SEMEAR nexedu.empresa (principalmente a IE, que faltava). NAO expoe segredos
      // (cert/senha/chave). CNPJ/IE/endereco ja saem impressos em toda DANFE — nao sao sigilosos.
