  ...
  const html = `
    <div style="font-family:'Segoe UI',Arial,sans-serif;max-width:600px;margin:0 auto;background:#f8fafc;border-radius:12px;overflow:hidden;">
      <div style="background:#1e293b;padding:20px 24px;">
        <h1 style="color:#f1f5f9;font-size:18px;margin:0;">GDP — ${pagamento ? 'Cobranca' : 'Confirmacao de Pedido'}</h1>
        <p style="color:#94a3b8;font-size:13px;margin:4px 0 0;">Lariucci & Ribeiro Pereira</p>
      </div>
      <div style="padding:24px;">
        ${pagamento ? '' : '<p style="font-size:14px;color:#334155;">Pedido registrado com sucesso!</p><div style="background:#fff;border:1px solid #e2e8f0;border-radius:8px;padding:16px;margin:16px 0;"><p style="margin:0 0 4px;font-size:13px;color:#64748b;">Protocolo</p><p style="margin:0;font-size:20px;font-weight:800;color:#3b82f6;font-family:monospace;">' + protocol + '</p></div>'}
        <table style="width:100%;font-size:13px;color:#334155;margin-bottom:12px;">
          ...
          ${pagamento ? '' : `<tr><td style="padding:4px 0;color:#64748b;">Responsavel:</td><td style="padding:4px 0;">${responsible || ''}</td></tr>`}
          ${pagamento ? '' : `<tr><td style="padding:4px 0;color:#64748b;">SRE:</td><td style="padding:4px 0;">${sre || ''}</td></tr>`}
        ...
        ${pagamento ? '' : `<table style="width:100%;border-collapse:collapse;font-size:13px;background:#fff;border:1px solid #e2e8f0;border-radius:8px;overflow:hidden;">
