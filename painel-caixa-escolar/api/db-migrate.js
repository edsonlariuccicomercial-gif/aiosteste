...
export default async function handler(req, res) {
  ...
  const migrations = [
    ...
    "CREATE POLICY IF NOT EXISTS anon_full_access ON contratos FOR ALL TO anon USING (true) WITH CHECK (true)",
    "CREATE POLICY IF NOT EXISTS anon_full_access ON pedidos FOR ALL TO anon USING (true) WITH CHECK (true)",
    "CREATE POLICY IF NOT EXISTS anon_full_access ON notas_fiscais FOR ALL TO anon USING (true) WITH CHECK (true)",
    "CREATE POLICY IF NOT EXISTS anon_full_access ON contas_receber FOR ALL TO anon USING (true) WITH CHECK (true)",
    "CREATE POLICY IF NOT EXISTS anon_full_access ON contas_pagar FOR ALL TO anon USING (true) WITH CHECK (true)",
    "CREATE POLICY IF NOT EXISTS anon_full_access ON entregas FOR ALL TO anon USING (true) WITH CHECK (true)",
    "CREATE POLICY IF NOT EXISTS anon_full_access ON clientes FOR ALL TO anon USING (true) WITH CHECK (true)",
    "CREATE POLICY IF NOT EXISTS anon_full_access ON nf_counter FOR ALL TO anon USING (true) WITH CHECK (true)",
    "CREATE POLICY IF NOT EXISTS anon_full_access ON data_snapshots FOR ALL TO anon USING (true) WITH CHECK (true)",
    "CREATE POLICY IF NOT EXISTS anon_full_access ON audit_log FOR ALL TO anon USING (true) WITH CHECK (true)",
    "CREATE POLICY IF NOT EXISTS anon_full_access ON empresas FOR ALL TO anon USING (true) WITH CHECK (true)",
    "CREATE POLICY IF NOT EXISTS auth_full_access ON contratos FOR ALL TO authenticated USING (true) WITH CHECK (true)",
    "CREATE POLICY IF NOT EXISTS auth_full_access ON pedidos FOR ALL TO authenticated USING (true) WITH CHECK (true)",
    "CREATE POLICY IF NOT EXISTS auth_full_access ON notas_fiscais FOR ALL TO authenticated USING (true) WITH CHECK (true)",
    "CREATE POLICY IF NOT EXISTS auth_full_access ON contas_receber FOR ALL TO authenticated USING (true) WITH CHECK (true)",
    "CREATE POLICY IF NOT EXISTS auth_full_access ON contas_pagar FOR ALL TO authenticated USING (true) WITH CHECK (true)",
    "CREATE POLICY IF NOT EXISTS auth_full_access ON entregas FOR ALL TO authenticated USING (true) WITH CHECK (true)",
    "CREATE POLICY IF NOT EXISTS auth_full_access ON clientes FOR ALL TO authenticated USING (true) WITH CHECK (true)",
    "CREATE POLICY IF NOT EXISTS auth_full_access ON nf_counter FOR ALL TO authenticated USING (true) WITH CHECK (true)",
    "CREATE POLICY IF NOT EXISTS auth_full_access ON data_snapshots FOR ALL TO authenticated USING (true) WITH CHECK (true)",
    "CREATE POLICY IF NOT EXISTS auth_full_access ON audit_log FOR ALL TO authenticated USING (true) WITH CHECK (true)",
    "CREATE POLICY IF NOT EXISTS auth_full_access ON empresas FOR ALL TO authenticated USING (true) WITH CHECK (true)",
  ];
